/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 66294b5fae5a2a1ce6fa59dc16d4c96e)
// Runtime types generated with workerd@1.20250906.0 2025-09-02 nodejs_compat
...
declare namespace NodeJS {
  interface ProcessEnv
    extends StringifyValues<
      Pick<Cloudflare.Env, "FOO" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET">
    > {}
}
...
type EventListenerObject<EventType extends Event = Event> = {
...
type RequestInit<Cf = CfProperties> = {
...
type KVNamespaceListKey<Metadata, Key extends string = string> = {
  name: Key;
  expiration?: number;
  metadata?: Metadata;
};
...
type KVNamespace<Key extends string = string> = {
  ...
  getWithMetadata<Metadata = unknown>(
    key: Key,
    options: KVNamespaceGetOptions<"text"> | "text"
  ): Promise<KVNamespaceGetWithMetadataResult<string, Metadata>>;
  getWithMetadata<ExpectedValue = unknown, Metadata = unknown>(
    key: Key,
    options: KVNamespaceGetOptions<"json"> | "json"
  ): Promise<KVNamespaceGetWithMetadataResult<ExpectedValue, Metadata>>;
  getWithMetadata<Metadata = unknown>(
    key: Key,
    options: KVNamespaceGetOptions<"arrayBuffer"> | "arrayBuffer"
  ): Promise<KVNamespaceGetWithMetadataResult<ArrayBuffer, Metadata>>;
  getWithMetadata<Metadata = unknown>(
    key: Key,
    options: KVNamespaceGetOptions<"stream"> | "stream"
...
type ReadableWritablePair<R = any, W = any> = {
  /**
...
type BGEM3InputQueryAndContexts1 = {
  /**
   * A query you wish to perform against the provided contexts. If no query is provided the model with respond with embeddings for contexts
   */
  query?: string;
...
type BGEM3OutputEmbeddingForContexts = {
  response?: number[][];
  shape?: number[];
  /**
   * The pooling method used in the embedding process.
...
type Ai_Cf_Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Input =
  ...
  | AsyncBatch;
type Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Prompt = {
  /**
   * The input text prompt for the model to generate a response.
   */
  prompt: string;
...
type Meta_Llama_3_3_70B_Instruct_Fp8_Fast_Messages = {
  /**
   * An array of message objects representing the conversation history.
   */
  messages: {
...
type Qwen2_5_Coder_32B_Instruct_Prompt = {
  /**
   * The input text prompt for the model to generate a response.
   */
  prompt: string;
...
type Qwen2_5_Coder_32B_Instruct_Messages = {
  /**
   * An array of message objects representing the conversation history.
   */
  messages: {
...
type Mistral_Small_3_1_24B_Instruct_Prompt = {
  /**
   * The input text prompt for the model to generate a response.
   */
  prompt: string;
...
type Google_Gemma_3_12B_It_Prompt = {
  /**
   * The input text prompt for the model to generate a response.
   */
  prompt: string;
...
type Google_Gemma_3_12B_It_Messages = {
  /**
   * An array of message objects representing the conversation history.
   */
  messages: {
...
type Ai_Cf_Meta_Llama_4_Prompt = {
  /**
   * The input text prompt for the model to generate a response.
   */
  prompt: string;
...
type Ai_Cf_Meta_Llama_4_Messages = {
  /**
   * An array of message objects representing the conversation history.
   */
  messages: {
...
declare namespace Rpc {
  ...
  export type RpcTargetBranded = {
    [__RPC_TARGET_BRAND]: never;
  };
  export type WorkerEntrypointBranded = {
    [__WORKER_ENTRYPOINT_BRAND]: never;
  };
  export type DurableObjectBranded = {
    [__DURABLE_OBJECT_BRAND]: never;
  };
  export type WorkflowEntrypointBranded = {
...
declare namespace TailStream {
  ...
  type TailEvent<Event extends EventType> = {
...
type WorkflowInstanceCreateOptions<PARAMS = unknown> = {
  /**
